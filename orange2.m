function [target,maskedRGBImage] = orange2(RGB)
...
% Combine both masks
target = sliderBW & polyBW;

% Initialize output masked image based on input image.
maskedRGBImage = RGB;

% Set background pixels where BW is false to zero.
maskedRGBImage(repmat(~target,[1 1 3])) = 0;
...
shiftVec = [0.012607 0.031739 0.490258];
I = I - shiftVec;
I = [I ones(size(I,1),1)]';

% Apply transformation matrix
tMat = [0.605522 0.156768 0.000000 -0.573524;
    0.014342 -0.141483 0.970348 -0.434155;
    -0.097042 0.957289 0.143414 8.177989;
...
hPoints(1).data = [-0.432431 -0.299132;
    -0.272271 -0.354729;
    -0.278373 -0.161461;
    -0.397349 -0.124396];
